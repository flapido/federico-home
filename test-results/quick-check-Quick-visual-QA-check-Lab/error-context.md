...
- Name: quick-check.spec.ts >> Quick visual QA check >> Lab
- Location: src\test\quick-check.spec.ts:43:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5174/lab
Call log:
  - navigating to "http://localhost:5174/lab", waiting until "load"
