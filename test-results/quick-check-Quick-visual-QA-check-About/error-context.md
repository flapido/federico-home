...
- Name: quick-check.spec.ts >> Quick visual QA check >> About
- Location: src\test\quick-check.spec.ts:55:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5174/about
Call log:
  - navigating to "http://localhost:5174/about", waiting until "load"
