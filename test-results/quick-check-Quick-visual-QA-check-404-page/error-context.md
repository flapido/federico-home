...
- Name: quick-check.spec.ts >> Quick visual QA check >> 404 page
- Location: src\test\quick-check.spec.ts:80:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5174/ruta-inexistente-404
Call log:
  - navigating to "http://localhost:5174/ruta-inexistente-404", waiting until "load"
