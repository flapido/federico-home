...
- Name: quick-check.spec.ts >> Quick visual QA check >> Proyectos/Subastas - LOCAL_DEMO
- Location: src\test\quick-check.spec.ts:25:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5174/proyectos/subastas
Call log:
  - navigating to "http://localhost:5174/proyectos/subastas", waiting until "load"
