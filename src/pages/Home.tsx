      ...
      <section className="max-w-[1280px] mx-auto px-6 md:px-8 py-8">
        <div className="rounded-[20px] border hairline bg-ink text-paper p-6 md:p-8 flex flex-col md:flex-row gap-6 justify-between">
          ...
          <div className="flex items-center gap-2 md:gap-4">
            {/* GitHub — icono simple con currentColor */}
            <button className="flex items-center gap-2 px-4 py-2 rounded-full border border-white/20 bg-white/5 text-ink text-[13px] font-medium hover:bg-white/10 transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ink focus-visible:ring-offset-paper" aria-label="GitHub de Federico Lapido" title="GitHub de Federico Lapido">
            ...
            {/* LinkedIn — icono simple con currentColor */}
            <button className="flex items-center gap-2 px-4 py-2 rounded-full border border-white/20 bg-white/5 text-ink text-[13px] font-medium hover:bg-white/10 transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ink focus-visible:ring-offset-paper" aria-label="LinkedIn de Federico Lapido" title="LinkedIn de Federico Lapido">
              <span className="w-4 h-4" aria-hidden="true">
            ...
            {/* WhatsApp — icono simple con currentColor */}
            <button className="flex items-center gap-2 px-4 py-2 rounded-full border border-white/20 bg-white/5 text-ink text-[13px] font-medium hover:bg-white/10 transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ink focus-visible:ring-offset-paper" aria-label="WhatsApp de Federico Lapido" title="WhatsApp de Federico Lapido">
              <span className="w-4 h-4" aria-hidden="true">
                <svg viewBox="0 0 20 20" fill="currentColor" width="16" height="16" focusable="false">
            ...
            {/* CV */}
            <a href="/cv" className="px-4 py-2 rounded-full border border-white/20 bg-white/5 text-white text-[13px] hover:bg-white/10 transition">CV</a>
          </div>
        </div>
